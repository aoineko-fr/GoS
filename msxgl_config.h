...
#define PT3_AUTOPLAY				FALSE	// Play music automatically
...
#define COMPRESS_USE_RLEP_FIXSIZE	TRUE	// Gize the data size as function input (loop up to terminator otherwise)
