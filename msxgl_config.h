...
#define VDP_USE_MODE_G2				0	// MSX1		Screen 2
...
#define VDP_USE_MODE_G4				1	// MSX2		Screen 5
...
// RLEp compression
#define COMPRESS_USE_RLEP			TRUE
#define COMPRESS_USE_RLEP_DEFAULT	TRUE
#define COMPRESS_USE_RLEP_FIXSIZE	TRUE
